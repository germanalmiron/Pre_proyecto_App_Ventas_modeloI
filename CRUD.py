...
def salirAplicacion():
    valor=messagebox.askquestion("Salir", "¿Está seguro que quiere salir de la aplicacion?")
    if valor == "yes":
        root.destroy()
...
def crear():
    ...
    try:
        ...
        messagebox.showwarning("ADVERTENCIA", "Ocurrio un error al crear el registro, verifique conexion con base de BBDD")
        pass
    limpiarCampos()
    mostrar()
...
########################### Colocar Widgets en las Ventanas ##########################
...
b2.place(x=180, y=90)
b3=Button(root, text="Mostrar la lista", command=mostrar)
b3.place(x=320, y=90)
